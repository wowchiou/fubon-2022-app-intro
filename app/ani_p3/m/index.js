...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_1.setTransform(299.5,911,0.78,0.78);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(29).to({_off:false},0).to({y:898.5,alpha:1},10,cjs.Ease.get(1)).wait(131));

	// fish02
	this.instance_2 = new lib.fish02_1();
	this.instance_2.setTransform(-20.4,427,0.871,0.871);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(22).to({_off:false},0).to({y:414.8,alpha:1},10,cjs.Ease.get(1)).wait(138));
...
(lib.film_m_black = function() {
	this.initialize(img.film_m_black);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,314,149);
...
(lib.fish01_m_black = function() {
	this.initialize(img.fish01_m_black);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,105,132);
...
(lib.fish022 = function() {
	...
	this.instance.setTransform(-76.9,-43.9,0.712,0.712);

	// 圖層_2
	this.instance_1 = new lib.fish00_03();
	this.instance_1.setTransform(-72.4,-107.9,1,1,5.4);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-82.9,-107.9,127,156.5);
...
p.nominalBounds = new cjs.Rectangle(37,8.1,127,156.5);
...
(lib.film_1 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-128.9,-113.9,1.05,1.05);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).wait(116));

	// 02
	this.instance_1 = new lib.film00_02_1();
	this.instance_1.setTransform(15.2,-0.8,0.889,0.889);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(49).to({regX:0.1,regY:0.1,rotation:-4.8,y:8.1},5,cjs.Ease.get(1)).to({regX:0,regY:0,rotation:0,y:-0.7},4,cjs.Ease.get(1)).to({regX:0.1,regY:0.1,rotation:-4.8,y:8.1},5,cjs.Ease.get(1)).to({regX:0,regY:0,rotation:0,y:-0.7},4,cjs.Ease.get(1)).wait(49));

	// 03
	this.instance_2 = new lib.film00_03();
	this.instance_2.setTransform(-131.9,-91.9);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A04DrIArnrIIuk3IH4BWIE/H2Ii0GNIt6CWg");
	mask.setTransform(-133.7,26.8);

	// 圖層 2
	this.instance_3 = new lib.film_black();
	this.instance_3.setTransform(-242.9,-47.9,1.073,1.073);
...
p.nominalBounds = new cjs.Rectangle(-242.9,-113.9,411.2,284.8);
...
p.nominalBounds = new cjs.Rectangle(-75.9,-107.9,170,216);
