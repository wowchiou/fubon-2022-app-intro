...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(22).to({_off:false},0).to({y:201,alpha:1},10,cjs.Ease.get(1)).wait(138));

	// boat
	this.instance_2 = new lib.boat_1();
	this.instance_2.setTransform(1075,717);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(27).to({_off:false},0).to({x:1055,alpha:1},9,cjs.Ease.get(1)).wait(134));

	// bridge
	this.instance_3 = new lib.bridge_1();
	this.instance_3.setTransform(594.5,543);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(19).to({_off:false},0).to({y:531,alpha:1},6,cjs.Ease.get(1)).wait(145));

	// space03
	this.instance_4 = new lib.space03();
	this.instance_4.setTransform(1383,1002,1,1,0,0,0,0,226);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(11).to({_off:false},0).to({y:814,alpha:1},6,cjs.Ease.get(0.97)).to({y:864},4,cjs.Ease.get(1)).wait(149));

	// space01
	this.instance_5 = new lib.space01();
	this.instance_5.setTransform(370,768,1,1,0,0,0,0.5,241);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(8).to({_off:false},0).to({y:590,alpha:1},6,cjs.Ease.get(0.97)).to({y:640},4,cjs.Ease.get(1)).wait(152));

	// space02
	this.instance_6 = new lib.space02();
	this.instance_6.setTransform(858,967,1,1,0,0,0,0.5,216);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(6).to({_off:false},0).to({y:799,alpha:1},6,cjs.Ease.get(0.97)).to({y:849},4,cjs.Ease.get(1)).wait(154));

	// txt
	this.instance_7 = new lib.txt_1();
	this.instance_7.setTransform(1176.5,-295.9);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(2).to({_off:false},0).to({y:164},6,cjs.Ease.get(-0.99)).to({y:112},4,cjs.Ease.get(0.97)).to({y:134},4,cjs.Ease.get(0.97)).to({y:124},4,cjs.Ease.get(0.97)).wait(150));
...
(lib.film_black = function() {
	this.initialize(img.film_black);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,322,204);


(lib.film00_01 = function() {
	this.initialize(img.film00_01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,283,204);


(lib.film00_02 = function() {
	this.initialize(img.film00_02);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,283,204);


(lib.film00_03 = function() {
	this.initialize(img.film00_03);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,283,204);


(lib.fish00_01 = function() {
	this.initialize(img.fish00_01);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,170,130);


(lib.fish00_02 = function() {
	this.initialize(img.fish00_02);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,170,130);


(lib.fish00_03 = function() {
	this.initialize(img.fish00_03);
}).prototype = p = new cjs.Bitmap();
...
(lib.fish01_black = function() {
	this.initialize(img.fish01_black);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,170,171);
...
(lib.fish022 = function() {
	this.initialize();

	// 圖層_1
	this.instance = new lib.fish02();
	this.instance.setTransform(-84.9,-64.9);

	// 圖層_2
	this.instance_1 = new lib.fish00_03();
	this.instance_1.setTransform(-77.9,-103.9);

	this.addChild(this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-84.9,-103.9,170,169);


(lib.film00_02_1 = function() {
	this.initialize();

	// 圖層_1
	this.instance = new lib.film00_02();
	this.instance.setTransform(-141.4,-101.9);

	this.addChild(this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-141.4,-101.9,283,204);
...
(lib.fish02_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 圖層_1
	this.instance = new lib.fish022();
	this.instance.setTransform(120,116);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(21).to({x:134},8,cjs.Ease.get(1)).wait(4).to({x:120},8,cjs.Ease.get(1)).wait(4).to({x:134},8,cjs.Ease.get(1)).wait(4).to({x:120},8,cjs.Ease.get(1)).wait(40));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(35,12,170,169);


(lib.film_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// 01
	this.instance = new lib.film00_01();
	this.instance.setTransform(-121.9,-101.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).wait(116));

	// 02
	this.instance_1 = new lib.film00_02_1();
	this.instance_1.setTransform(19.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(49).to({rotation:-4.8,y:10},5,cjs.Ease.get(1)).to({rotation:0,y:0},4,cjs.Ease.get(1)).to({rotation:-4.8,y:10},5,cjs.Ease.get(1)).to({rotation:0,y:0},4,cjs.Ease.get(1)).wait(49));

	// 03
	this.instance_2 = new lib.film00_03();
	this.instance_2.setTransform(-121.9,-101.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2}]}).wait(116));

	// 圖層_6 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AqYDbIApnKIIHkiIHVBRIEsHTIirFyIs7CNg");
	mask.setTransform(-116.9,-32.4);

	// 圖層 2
	this.instance_3 = new lib.film_black();
	this.instance_3.setTransform(-160.9,-101.9);

	this.instance_3.mask = mask;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3}]}).wait(116));
